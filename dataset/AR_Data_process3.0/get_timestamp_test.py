...
VIDEO_LABELS = {
    ...
    # "interaction_20260131_071918.mp4": 1,  # 选择
    ...
    # "interaction_20260227_124133.mp4": 0,  # 菜单（废案）
    ...
    "interaction_20260301_073041.mp4": 0,  # 菜单
    ...
    # "interaction_20260306_072344.mp4": 0,  # 菜单
...
def vad_segments_refined(audio_path):
    ...
    for idx, frm in enumerate(frames):
        ...
        valid_speech = is_speech and (frm_rms > q70_rms * 0.8)
